...
int main(void)
{
    ...
    SOFTWARE_VERSION_STR = "qomu-blinky/firmware/qf_hello";
    ...
    dbg_str("\n\n");
    dbg_str( "##########################\n");
    dbg_str( "My QuickFeather firmware\n");
    dbg_str( "SW Version: ");
    ...
    dbg_str( "\n\nHello from the Cortex-M4!\n");
    dbg_str( "Press USR to cycle the LED color. Type 'help' for commands.\n\n");

    led_button_task_start();
